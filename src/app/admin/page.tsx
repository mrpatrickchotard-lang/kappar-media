  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <Link href="/admin/experts" className="bg-card border border-primary rounded-2xl p-6 hover:border-secondary transition-all">
          ...
          <p className="text-sm text-tertiary">{stats.featuredExperts} featured</p>        </Link>        
        
        <Link href="/admin/bookings" className="bg-card border border-primary rounded-2xl p-6 hover:border-secondary transition-all">
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 rounded-full accent-primary flex items-center justify-center">
              <svg className="w-6 h-6 text-[var(--accent-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-sm text-tertiary">{stats.pendingBookings} pending</p>        </Link>        
        
        <Link href="/admin/content" className="bg-card border border-primary rounded-2xl p-6 hover:border-secondary transition-all">
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 rounded-full accent-primary flex items-center justify-center">
              <svg className="w-6 h-6 text-[var(--accent-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-sm text-tertiary">{stats.featuredArticles} featured</p>        </Link>      
</div>      
        ...
        <div className="bg-card border border-primary rounded-2xl p-6">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              </div>              <span className="text-primary">New Article</span>            </Link>            
            ...
            >
              ...
              </div>              <span className="text-primary">Add Expert</span>            </Link>          </div>        </div>        
        
        <div className="bg-card border border-primary rounded-2xl p-6">
          <h3 className="font-display text-lg text-primary mb-6">Recent Activity</h3>          
          <p className="text-tertiary text-sm">No recent activity to display.</p>        </div>      </div>    </div>  );
}
